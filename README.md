...
如果你的游戏是微软 Xbox 版，或者某些特殊情况下，程序没有获取到正确的游戏位置，那么你只需要启动一次游戏，点击程序右上角的“自动定位”按钮就可以自动填写游戏路径。  
如果“自动定位”报错或者没有找到游戏路径，请使用管理员权限运行补丁安装程序。
...
8. 正常情况下，游戏已经可以正常显示中文了。如果还没有显示对应语言，只需要再在游戏内切换一下语言即可。
