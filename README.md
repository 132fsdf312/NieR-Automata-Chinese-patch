...
Steam Deck 掌机版游戏，只需下载“NieR_Automata龙版汉化1.2.0(Steam Deck专用).zip”，解压后，将得到的两个新文件手动移动到游戏所在目录中的“data”文件夹里，并覆盖同名文件。
...
> File: NieR_Automata龙版汉化1.2.0(Steam Deck专用).zip  
...
游戏主菜单本身不支持语言切换，因此目前版本依然保留默认英文。  
至于游戏主界面中，顶部选项卡“MAP”、“QUEST”、“ITEM”、“WEAPON”、“SKILL”、“DATA”、“SYSTEAM”，属于官方为了游戏沉浸感，刻意保留的英文。  
以及，游戏一周目中 BOSS 的名字并非没有翻译，而是尼尔世界观的专有文字，与我们现实世界的文字并不相同，因此天邈、轩辕的中文翻译属于误翻。  
...
目前，在 QQ 群中，我已经制作并发布了新的字体重制补丁。新的字体补丁重做了全部文字，并且完整翻译了上述所说的所有英文内容，包括主菜单、主界面、设置中的选项等。  
因为是测试版可能还存在少许问题（仅限于文字显示模糊、变形、大小不一等问题，并不会影响游戏稳定性），如有需要，欢迎测试使用。
