...
电脑端 Steam 版和微软 Xbox 版游戏，只需下载“**NieR_Automata龙版汉化1.2.1（电脑版）.zip**”，解压后，找到“**LangToolsSetup.exe**”即可启动安装程序。  
Steam Deck 掌机版游戏，只需下载“**NieR_Automata龙版汉化(Steam Deck专用).zip**”，解压后，将得到的两个新文件手动移动到游戏所在目录中的“**data**”文件夹里，并覆盖同名文件。
